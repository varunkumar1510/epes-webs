...
const clients = [
  ...
  { name: 'Power Enterprises', logo: '/client-logos/client13.jpeg' },
  { name: 'Dynamic Energy', logo: '/client-logos/client14.webp' },
  { name: 'Summit Group', logo: '/client-logos/client15.png' },
  { name: 'Electric Solutions', logo: '/client-logos/client16.png' },
  { name: 'ABC Corporation', logo: '/client-logos/client17.jpeg' },
  { name: 'Tech Solutions', logo: '/client-logos/client18.png' },
  { name: 'Global Industries', logo: '/client-logos/client19.png' },
  { name: 'Innovate Systems', logo: '/client-logos/client20.jpeg' },
